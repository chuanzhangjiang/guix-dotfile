(define-module (chuanguix systems common)
  #:use-module (chuanguix utils)
  #:use-module (chuanguix home-services emacs)
  #:use-module (chuanguix home-services desktop)
  #:use-module (chuanguix home-services udiskie)
